...
**軟體工程師 · 全端 · bubblechickenlab**

<br/>

[![English](https://img.shields.io/badge/English-D9D2C5?style=for-the-badge)](../README.md)
[![繁體中文](https://img.shields.io/badge/繁體中文-2C2C2C?style=for-the-badge)](README.zh-TW.md)
[![简体中文](https://img.shields.io/badge/简体中文-D9D2C5?style=for-the-badge)](README.zh-CN.md)
...
我是軟體工程師，以全端方式交付產品 — schema、API、UI 到部署。目前主要落在 web，並往 mobile、desktop、enterprise 與 AI 方案延伸。

我的工作介於工程與敘事之間：作品集即建築、互動式履歷、以及源自真實工作流程的工具。
...
賽博龐克大樓履歷 — 逐層瀏覽學歷、專案與聯絡方式。開機動畫、深淺主題、SVG fallback。

[![Live](https://img.shields.io/badge/線上-前往-2C2C2C?style=flat-square)](https://www.bubblechickenlab.com/towerzero)
...
| **電腦科學基礎** | 資料結構與演算法 · 資料庫 · 物件導向設計 · 系統設計 · 除錯與問題排查 |
| **語言能力** | 英語（流利）· 中文（母語） |
...
*SWE · 全端。開放雪梨軟體工程職缺 — web、mobile、desktop、enterprise 與 AI。*
