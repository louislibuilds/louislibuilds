...
[![English](https://img.shields.io/badge/English-D9D2C5?style=for-the-badge)](../README.md)
[![繁體中文](https://img.shields.io/badge/繁體中文-D9D2C5?style=for-the-badge)](README.zh-TW.md)
[![简体中文](https://img.shields.io/badge/简体中文-2C2C2C?style=for-the-badge)](README.zh-CN.md)
...
我是一位喜欢把想法变成实际产品的开发者。我专注于打造界面简洁、好用且易于维护的现代网页应用。

我热衷于学习新技术、探索 AI，并通过各种 side project 持续提升自己的能力。

不写代码的时候，我大概在打游戏、健身、做饭，或者计划下一趟旅行。
...
WebGL 入口页面、内容深度层、自建 admin CMS，并支持三语内容（EN / zh-TW / zh-CN）。

[![Live](https://img.shields.io/badge/在线-nagi--three.vercel.app-2C2C2C?style=flat-square)](https://nagi-three.vercel.app/)
...
看板式流程（7 个阶段）、本地优先存储、JSON 导入导出、多语言 — 源自真实求职痛点。

[![Live](https://img.shields.io/badge/在线-jobo--mu.vercel.app-2C2C2C?style=flat-square)](https://jobo-mu.vercel.app/)
...
React · TypeScript · Vite · PDF 导出

实时 A4 预览、四种模板、区块排序、草稿导入导出 — 我自己求职时每天在用的工具。

[![Live](https://img.shields.io/badge/在线-resumade--ivory.vercel.app-2C2C2C?style=flat-square)](https://resumade-ivory.vercel.app/)
...
48 小时黑客松 MVP：地图探索 + 7 天天气预报。负责架构、API 规格与交付。
...
| 项目 | 技术 | 说明 |
|------|------|------|
| [Mock Interview Coach](https://github.com/louis-li-builds/mock-interview-coach-stt-star-feedback-scoring-nlp-uts-project) | Python, NLP, STT | UTS 团队项目 — 以 STAR 架构评分模拟面试 |
| [VTuber Motion Pipeline](https://github.com/louis-li-builds/dl-cnn-UTSproject51-vtuber-mediapipe-kalidokit) | Python, MediaPipe, CNN | 深度学习课程项目 |
...
| **数据库** | ![Supabase](https://img.shields.io/badge/Supabase-3FCF8E?style=for-the-badge&logo=supabase&logoColor=white) ![MongoDB](https://img.shields.io/badge/MongoDB-47A248?style=for-the-badge&logo=mongodb&logoColor=white) ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=for-the-badge&logo=postgresql&logoColor=white) |
| **操作系统** | ![Windows](https://img.shields.io/badge/Windows-0078D6?style=for-the-badge&logo=windows&logoColor=white) ![Linux](https://img.shields.io/badge/Linux-FCC624?style=for-the-badge&logo=linux&logoColor=black) ![macOS](https://img.shields.io/badge/macOS-000000?style=for-the-badge&logo=apple&logoColor=white) |

---

<div align="center">

*目前正在寻找悉尼的 graduate SWE、全栈与云端相关职位。*
