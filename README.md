...
[![English](https://img.shields.io/badge/English-2C2C2C?style=for-the-badge)](README.md)
[![繁體中文](https://img.shields.io/badge/繁體中文-D9D2C5?style=for-the-badge)](docs/README.zh-TW.md)
[![简体中文](https://img.shields.io/badge/简体中文-D9D2C5?style=for-the-badge)](docs/README.zh-CN.md)
...
Helluu, this is bubblechickenlab. :)

I'm a developer who enjoys turning ideas into practical products. I build modern web applications with a focus on clean design, usability, and maintainable code.

I enjoy learning new technologies, exploring AI, and continuously improving my craft through side projects.
...
Kanban pipeline (7 stages), local-first storage, JSON import/export, i18n — built from real job-search pain points.

[![Live](https://img.shields.io/badge/Live-jobo--mu.vercel.app-2C2C2C?style=flat-square)](https://jobo-mu.vercel.app/)
...
React · TypeScript · Vite · PDF export

Live A4 preview, four templates, section reorder, draft import/export — the tool behind my own applications.

[![Live](https://img.shields.io/badge/Live-resumade--ivory.vercel.app-2C2C2C?style=flat-square)](https://resumade-ivory.vercel.app/)

</td>
<td width="50%" valign="top">

### [your-rock-is-coming](https://github.com/louislibuilds/your-rock-is-coming)
*UniHack 2026 — Team Lead*

React · Node.js · Leaflet · REST

48-hour hackathon MVP: map discovery + 7-day weather forecasts. Led architecture, API contracts, and delivery.
...
| Project | Stack | Notes |
|---------|-------|-------|
| [Mock Interview Coach](https://github.com/louis-li-builds/mock-interview-coach-stt-star-feedback-scoring-nlp-uts-project) | Python, NLP, STT | UTS team project — STAR-based interview scoring |
| [VTuber Motion Pipeline](https://github.com/louis-li-builds/dl-cnn-UTSproject51-vtuber-mediapipe-kalidokit) | Python, MediaPipe, CNN | Deep Learning coursework |
...
*Currently open to graduate SWE, full-stack, and cloud-oriented roles in Sydney.*

<br/>

![Profile Views](https://komarev.com/ghpvc/?username=louislibuilds&color=C4B8A8&style=flat-square)
